...
index.js Gabungan script lengkap untuk: GitHub Secrets — simpan cookie per akun:

Nama secret: COOKIE_akun
Multi-akun Facebook posting + like berdasarkan schedule di Excel (sheet "posting" dan "like")
Ambil cookies dari GitHub Secrets / environment variables (COOKIES_JSON / COOKIES / COOKIES_)
...
---->> rename dulu nama fito/video nya,masuk ke file manager,edit nama file nya misal akun1_foto.jpg,akun2_video.mp4 dll
